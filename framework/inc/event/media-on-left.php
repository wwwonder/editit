<?php
/**
 * Event Single Template :  Medium Media on Left
 *
 *
 ...
 * @filesource     wp-content/themes/editit/framework/inc/event/media-on-left.php
 */
?>
<?php
  global $smof_data;
...
?>
<article class="event event-single-item event-mediaonleft clearfix">

  <?php if ( rwmb_meta( 'editit_selecteventmedia' ) == "video" ): ?>

    <?php if( rwmb_meta('editit_textareavideoembed')): ?>
    <div id="event-video" class="event-video embed-video ten columns">
