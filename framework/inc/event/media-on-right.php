<?php
/**
 * Event Single Template :  Medium Media on Right
 *
 *
 * @file           media-on-right.php
 * @package        editit
 * @author         Masato Takahashi
 * @copyright      2014 wwwonder
 * @version        Release: 1.0.0
 * @filesource     wp-content/themes/editit/framework/inc/event/media-on-right.php
 */
?>
<?php
  global $smof_data;
...
?>
<article class="event event-single-item event-mediaonright clearfix">
  ...
  <?php if ( rwmb_meta( 'editit_selecteventmedia' ) == "video" ): ?>
    ...
    <div id="event-video" class="event-video ten columns">
  ...
  <?php elseif ( rwmb_meta( 'editit_selecteventmedia' ) == "image" ): ?>
    ...
    <div id="event-slider" class="event-slider flexslider ten columns">
    <?php else: ?>
    <div id="event-list" class="event-list ten columns">
    <?php endif; ?>
