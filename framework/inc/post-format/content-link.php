 ...
 * @filesource     wp-content/themes/editit/framework/inc/post-format/content-link.php
 */
?>
<article class="post clearfix">
  ...
  <div class="post-image">
    <a href="<?php echo esc_attr(rwmb_meta('editit_urllinkurl')); ?>" title="<?php printf( esc_attr__('Permalink to %s', 'editit'), the_title_attribute('echo=0') ); ?>" class="external-link" rel="bookmark" target="_blank">
