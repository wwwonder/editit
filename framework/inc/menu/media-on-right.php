<?php
/**
 * Menu Single Template :  Medium Media on Right
 *
 *
 ...
 * @filesource     wp-content/themes/editit/framework/inc/menu/media-on-right.php
 */
?>
<?php
  global $smof_data;
...
?>
<article class="menu menu-single-item menu-mediaonright clearfix">
