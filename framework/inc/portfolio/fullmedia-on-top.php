<?php
/**
 * Portfolio Single Template :  Full Media on Top
 *
 *
 ...
 * @filesource     wp-content/themes/editit/framework/inc/portfolio/fullmedia-on-top.php
 */
?>
<?php
  global $smof_data;
...
?>
<article class="portfolio portfolio-single-item portfolio-fullmediaontop clearfix">

  <?php if ( rwmb_meta( 'editit_selectportfoliomedia' ) == "video" ): ?>

    <?php if( rwmb_meta('editit_textareavideoembed')): ?>
    <div id="portfolio-video" class="portfolio-video embed-video sixteen columns">
  ...
  <?php elseif ( rwmb_meta( 'editit_selectportfoliomedia' ) == "image" ): ?>
    ...
    <?php if ( $images = rwmb_meta( 'editit_imagegallery', 'type=image' ) ): ?>
      ...
      <div id="portfolio-slider" class="portfolio-slider flexslider sixteen columns">
        <ul class="slides">
      ...
      <div id="portfolio-list" class="portfolio-list sixteen columns">
        <ul class="slides">
        <?php foreach( $images as $image ) : ?>
          <li class="post-image">
             <a href="<?php echo $image['full_url']; ?>" class="lightbox prettyPhoto" title="<?php echo $image['title']; ?>" rel="prettyPhoto[slides]">
  ...
  <div class="portfolio-content <?php if( rwmb_meta( 'editit_selectshowportfolioinformation' ) ) { echo 'eleven'; } else { echo 'sixteen'; } ?> columns">
  ...
  <div class="portfolio-information five columns">
